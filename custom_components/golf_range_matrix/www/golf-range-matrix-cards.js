...
class NovaShotTracerCard extends HTMLElement {
  ...
  render() {
    ...
    const clubBtns = clubOpts.map(o => `<button class="club ${o === curClub ? 'on' : ''}" data-club="${novaEsc(o)}">${novaEsc(o)}</button>`).join('');
    ...
    this.innerHTML = `<ha-card><div class="shell">
      ...
      .clubBar{margin-top:14px;padding:14px 16px;border:1px solid rgba(255,255,255,.12);border-radius:20px;background:rgba(255,255,255,.06)}.clubBar .clubHead{display:flex;align-items:baseline;gap:12px;flex-wrap:wrap;margin-bottom:11px}.clubBar .clubTitle{color:rgba(255,255,255,.66);text-transform:uppercase;font-size:11px;letter-spacing:.16em;font-weight:900}.clubBar .clubNow{font-size:18px;font-weight:950;color:#f7ff8a;letter-spacing:-.01em}.clubBar .clubLast{margin-left:auto;color:rgba(255,255,255,.5);font-size:11px;font-weight:800;letter-spacing:.06em;text-transform:uppercase}.clubBar .clubBtns{display:flex;flex-wrap:wrap;gap:8px}.clubBar .club{padding:9px 14px;border-radius:999px;border:1px solid rgba(255,255,255,.16);background:rgba(255,255,255,.07);color:rgba(255,255,255,.84);font-size:14px;font-weight:900;letter-spacing:.01em;cursor:pointer;transition:transform .08s ease}.clubBar .club:hover{background:rgba(255,255,255,.12)}.clubBar .club.on{background:rgba(247,255,92,.16);border-color:rgba(247,255,92,.6);color:#f7ff8a;box-shadow:0 0 16px rgba(247,255,92,.22)}.clubBar .club:active{transform:scale(.94)}.clubBar .clubEmpty{color:rgba(255,255,255,.5);font-size:13px;font-weight:700}
      ${novaTvStyles}
    </style>`;
