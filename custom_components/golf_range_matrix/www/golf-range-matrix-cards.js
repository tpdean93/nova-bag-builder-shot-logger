...
class NovaShotTracerCard extends HTMLElement {
  ...
  render() {
    ...
    this.innerHTML = `<ha-card><div class="shell">
      ...
      .clubBar{margin-top:12px;padding:10px 12px;border:1px solid rgba(255,255,255,.12);border-radius:16px;background:rgba(255,255,255,.06)}.clubBar .clubHead{display:flex;align-items:baseline;gap:9px;flex-wrap:wrap;margin-bottom:8px}.clubBar .clubTitle{color:rgba(255,255,255,.6);text-transform:uppercase;font-size:10px;letter-spacing:.14em;font-weight:900}.clubBar .clubNow{font-size:14px;font-weight:950;color:#f7ff8a;letter-spacing:-.01em}.clubBar .clubLast{margin-left:auto;color:rgba(255,255,255,.45);font-size:9.5px;font-weight:800;letter-spacing:.06em;text-transform:uppercase}.clubBar .clubBtns{display:flex;flex-wrap:wrap;gap:6px}.clubBar .club{padding:4px 10px;border-radius:999px;border:1px solid rgba(255,255,255,.16);background:rgba(255,255,255,.07);color:rgba(255,255,255,.82);font-size:12px;font-weight:800;letter-spacing:.01em;line-height:1.5;cursor:pointer;transition:transform .08s ease}.clubBar .club:hover{background:rgba(255,255,255,.12)}.clubBar .club.on{background:rgba(247,255,92,.16);border-color:rgba(247,255,92,.6);color:#f7ff8a;box-shadow:0 0 12px rgba(247,255,92,.2)}.clubBar .club:active{transform:scale(.94)}.clubBar .clubEmpty{color:rgba(255,255,255,.5);font-size:12px;font-weight:700}
      ${novaTvStyles}
    </style>`;
